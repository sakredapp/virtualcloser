...
export const ADDON_CATALOG: Record<AddonKey, AddonDef> = {
  ...
  addon_ghl_crm: {
    ...
    whats_included: [
      ...
      'Pipeline stage moves fire your GHL workflows',
      'Inbound webhook for tag/contact/appointment events',
      'Auto-tagging on dialer outcomes (vc-confirmed, vc-reschedule-requested, etc.)',
      'AddNote stamps on every stage move with rep context',
    ],
