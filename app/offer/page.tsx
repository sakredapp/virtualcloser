      ...
      <section className="card" style={{ marginTop: 0 }}>
        ...
        <details className="collapse" style={{ marginTop: '0.9rem' }}>
          ...
          <ul className="list" style={{ maxHeight: 'none', marginTop: '0.5rem' }}>
            ...
            <li className="row"><div><p className="name">Lead handoff with full context</p><p className="meta">Manager: &ldquo;give the Acme deal to Sarah&rdquo; &mdash; reassigns the lead, pings Sarah on Telegram with the history and notes attached. No more &ldquo;wait, what was the last thing they said?&rdquo; meetings.</p></div></li>
